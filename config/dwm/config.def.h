...
#define TAGKEYS(KEY,TAG) \
	...
	{ MODKEY|ControlMask|ShiftMask, KEY,      toggletag,      {.ui = 1 << TAG} }, \
	{ MODKEY|ALTMOD,              KEY,      tagnextmon,     {.ui = 1 << TAG} }, \
	{ MODKEY|ALTMOD|ShiftMask,    KEY,      tagprevmon,     {.ui = 1 << TAG} }, \
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_cyan, "-sf", col_gray4, "-l", "20", "-bw", "1", "-c", NULL };
...
static const Key keys[] = {
	...
	{ 0,                            XK_F2,      spawn,          SHCMD("pamixer -d 3") },
    { 0,                            XK_F3,      spawn,          SHCMD("pamixer -i 3") },
    { 0,                            XK_F5,      spawn,          SHCMD("light -U 5") },
	{ 0,                            XK_F6,      spawn,          SHCMD("light -A 5") },
};
